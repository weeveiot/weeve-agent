...
aws cloudformation deploy --template-file node_instance.yaml --stack-name weeve-edge-node-demo-2 --parameter-overrides InstanceName=Weeve_Edge_Node_Demo_1 KeyName=edge_node_demo_1 VpcId=vpc-64669319
aws cloudformation delete-stack --stack-name weeve-edge-node-demo-2
